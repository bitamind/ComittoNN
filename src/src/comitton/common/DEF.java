...
public class DEF {
	...
	public static final int DEFAULT_FONTTILE = 10; // 16sp
	...
	public static final int DEFAULT_VOLSCRL = 7; // 32ドット
	public static final int DEFAULT_SCRLRNGW = 6; // 35% ((6+1)*5)
	public static final int DEFAULT_SCRLRNGH = 6; // 35% ((6+1)*5)
	public static final int DEFAULT_ITEMMARGIN = 8; // 4sp
	public static final int DEFAULT_EFFECTTIME = 7; // 350msec
	...
	public static final int DEFAULT_THUMBSIZEW = 12; // 160 (12 * 10 + 40)
	public static final int DEFAULT_THUMBSIZEH = 8; // 120 (8 * 10 + 40)
	...
	static public String getThumbnailStr(int w, int h, String summ1) {
		// ドット単位
		return calcThumbnailSize(w) + " " + summ1 + " x " + calcThumbnailSize(h) + " " + summ1;
	}
	...
	static public String getFontDirectory() {
		return Environment.getExternalStorageDirectory() + "/comitto/font/";
	}

	static public String getConfigDirectory() {
		return Environment.getExternalStorageDirectory() + "/comitto/conf/";
	}
	...
	static public String getBaseDirectory() {
		return Environment.getExternalStorageDirectory() + "/comitto/";
	}
